 ...
 ****
 ...
 Now that we have a **DependencyContainer** to manage dependencies, we can use it to create a **SettingsViewController**. But as the **DependencyContainer** grows, it can do a lot more than just creating a **SettingsViewController**. Exposing all of its factory methods and dependencies is not preferred, so it's a good idea to mask them.
