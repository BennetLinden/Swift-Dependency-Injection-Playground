...
/*:
 This **DependencyProvider** has two factory methods: one for creating the **SettingsViewController** and one for creating the **SettingsPresenter**. Both methods don't take any arguments, as to be able to create the **SettingsViewController** with a **SettingsPresenter**, without knowing about the **SettingsPresenter**.
